...
### As a user, I want to view images, comment, like and add my own content to a single page application that focuses on specifically on the dance medium. The images posted create an interactive user experience where I can look at, read captions, and post my own "stories". 
